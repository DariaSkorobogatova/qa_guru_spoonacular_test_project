<h1> Проект по тестированию UI и API Spoonacular - сайта, позволяющего выбирать и создавать рецепты, планы питания, управлять продуктовой корзиной и многое другое"</h1>
